 ...
 * Path: app/mrs/config_mrs/env_mrs.php
 * Purpose: Shared database configuration and path constants for the standalone MRS stack.
 */
...
// ============================================
// Database configuration (shared with Express)
// ============================================

define('DB_HOST', getenv('MRS_DB_HOST') ?: (getenv('EXPRESS_DB_HOST') ?: 'mhdlmskp2kpxguj.mysql.db'));
define('DB_NAME', getenv('MRS_DB_NAME') ?: (getenv('EXPRESS_DB_NAME') ?: 'mhdlmskp2kpxguj'));
define('DB_USER', getenv('MRS_DB_USER') ?: (getenv('EXPRESS_DB_USER') ?: 'mhdlmskp2kpxguj'));
define('DB_PASS', getenv('MRS_DB_PASS') ?: (getenv('EXPRESS_DB_PASS') ?: 'BWNrmksqMEqgbX37r3QNDJLGRrUka'));
